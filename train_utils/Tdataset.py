...
class SVS_Dataset:
    def __init__(self,paths ,config,vocab_list):
    ...
    def __getitem__(self, i):
        ...
        return{'type':'svs','f0':f0.astype(np.float32),'gtmel':mel,'mel2ph':mel2ph,'ph_idx':ph_idx,'datal':len(mel),'promot':promot,'tasktype':0}
